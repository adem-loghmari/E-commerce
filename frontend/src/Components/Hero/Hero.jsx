...
const Hero = () => {
  return (
    <section className="w-full bg-gradient-to-r from-gray-900 via-blue-900 to-gray-800 py-16 md:py-24 flex items-center justify-center relative overflow-hidden">
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between px-6 gap-12">
        <div className="flex-1 flex flex-col items-start z-10">
          ...
          <button className="hero-latest-btn mt-8 px-8 py-4 bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white text-lg font-bold rounded-full shadow-xl flex items-center gap-4 hover:scale-105 hover:shadow-2xl transition-transform backdrop-blur-lg">
        ...
        <div className="flex-1 flex items-center justify-center relative z-10 pt-8">
          <div className="rounded-3xl overflow-hidden shadow-2xl bg-white/10 backdrop-blur-lg p-4 md:p-8">
            <img src={hero_image} alt="hero image" className="w-72 md:w-[28rem] h-auto object-contain" />
          </div>
        </div>
      </div>
    </section>
